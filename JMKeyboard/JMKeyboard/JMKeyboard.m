...
//  Copyright © 2020 任雪强. All rights reserved.
//
...
- (void)addControl{
    ...
    [deleteBtn addTarget:self action:@selector(codeDeleteBtnClick) forControlEvents:UIControlEventTouchUpInside];
    ...
    [numPadCheckBtn addTarget:self action:@selector(codeSwitchBtnClick:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [wordBtn addTarget:self action:@selector(codeSwitchBtnClick:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [okBtn addTarget:self action:@selector(codeOkBtnClick) forControlEvents:UIControlEventTouchUpInside];
...
#pragma mark - 符号删除
- (void)codeDeleteBtnClick{
    [XQKeyboardTool deleteStringForResponder:self.responder];
}

#pragma mark -符号转换
- (void)codeSwitchBtnClick:(UIButton *)btn{
...
- (void)addControl{
    ...
    wordSwitchBtn.tag = 3;
    [wordSwitchBtn addTarget:self action:@selector(numSwitchBtnClick:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [symbolSwitchBtn addTarget:self action:@selector(numSwitchBtnClick:) forControlEvents:UIControlEventTouchUpInside];
    ...
    UIButton *deleteBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [deleteBtn setBackgroundImage:[UIImage imageNamed:@"images.bundle/keypadDeleteBtn"] forState:UIControlStateNormal];
    [deleteBtn addTarget:self action:@selector(numDeleteBtnClick) forControlEvents:UIControlEventTouchUpInside];
    [self addSubview:deleteBtn];
    deleteBtn.tag = 11;
    ...
    UIButton *okBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [okBtn setTitle:@"完成" forState:UIControlStateNormal];
    [okBtn addTarget:self action:@selector(numOkBtnClick) forControlEvents:UIControlEventTouchUpInside];
    [self addSubview:okBtn];
    [okBtn setBackgroundImage:[UIImage imageNamed:@"images.bundle/keypadLongBtn"] forState:UIControlStateNormal];
    okBtn.tag = 15;
...
- (void)numSwitchBtnClick:(UIButton *)btn{
...
@interface JMKeyboard ()<XQKeyboardNumPadDelegate,XQKeyboardWordPadDelegate,XQKeyboardSymbolPadDelaget>
